...
export function buildPersonaTraceContext({
  ...
  promptSource = "",
  promptVersion = null,
  dynamicPromptName = null,
  dynamicPromptSource = null,
  dynamicPromptVersion = null,
  rubricPromptName = null,
  rubricPromptSource = null,
  rubricPromptVersion = null
}) {
  ...
  return {
    ...
    metadata: {
      ...
      promptVersion,
      dynamicPromptName: dynamicPromptName || "",
      dynamicPromptSource: dynamicPromptSource || "",
      dynamicPromptVersion: dynamicPromptVersion ?? "",
      rubricPromptName: rubricPromptName || "",
      rubricPromptSource: rubricPromptSource || "",
